...
export default function OnboardingReady() {
  ...
  return (
    <div
      ...
      style={{
        background: [
          // 칩 클러스터 중앙(=팀 협업 위치) 높이에 글로우 중심
          'radial-gradient(70% 50% at 50% 50%, rgba(134, 148, 223, 0.40) 0%, rgba(232, 235, 247, 0.65) 40%, rgba(255,255,255,0) 75%)',
          // 상단 보랏빛 hint
          'radial-gradient(90% 35% at 50% 0%, rgba(213, 221, 242, 0.7) 0%, rgba(255, 255, 255, 0) 60%)',
          // 베이스
